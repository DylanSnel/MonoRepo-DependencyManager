...
namespace Slyng.Monorepo.DependencyManager.Helpers
{
    public static  class Encryption
    {
        ...
        {
            byte[] bytesToBeEncrypted = Encoding.UTF8.GetBytes(secret);
        ...
        public static string Decrypt(this string encryptedSecret, string password)
        {
            byte[] bytesToBeDecrypted = Convert.FromBase64String(encryptedSecret);
